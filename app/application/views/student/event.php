...
<a class="btn btn-primary right " href="<?php echo base_url();?>main/addevent" style="float:right">Add Event</a>
                        <h5>Events </h5>
                        <br>
<br>                        
...
?>
                    ...
                    <tr class="gradeC">
                        <td class="center"><?php echo $key->sno;?></td>
                        <td class="center"><?php echo $key->eventType;?></td>
