...
<body>
                                                        ...
                                                        <ul>
                                                            ...
                                                            foreach ($subject as $sub ) {
                                                                if ($sub->course == $sem->course && $sub->branch == $sem->branch && $sub->semester == $sem->semester){
                                                                    ...
                                                                    ?> data-jstree='{"icon":"glyphicon glyphicon-inbox"}'><a href="<?php echo base_url();?>main/video/<?php echo $sub->course;?>/<?php echo $sub->branch;?>/<?php echo $sub->semester;?>/<?php echo $sub->subject;?>"><?php echo $sub->subject;?>
    ...
    # code...
                                ...
                                <div class="file-box">
                                    <div class="file">
                                        <a href="<?php echo base_url();?>main/view_video/<?php echo $d_id;?>/<?php echo $d_title;?>/<?php echo $d_description;?>/<?php echo $d_date;?>/<?php echo $dashcourse;?>/<?php echo $dashbranch;?>/<?php echo $dashsemester;?>/<?php echo $dashsubject;?>">
