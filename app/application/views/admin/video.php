...
<body>
                ...
                <div class="col-lg-5">
                    <div class="ibox float-e-margins">
                     <div class="ibox-content">
                         ...
                         <button class="btn btn-primary btn-block" data-toggle="modal" data-target="#myModal">Upload Video</button>
                         <div class="hr-line-dashed"></div>
                         <div id="jstree1">
                            <ul>
                               <?php 
                                                        ...
                                                        <ul>
                                                            ...
                                                            foreach ($subject as $sub ) {
                                                                if ($sub->course == $sem->course && $sub->branch == $sem->branch && $sub->semester == $sem->semester){
                                                                    ...
                                                                    ?> data-jstree='{"icon":"glyphicon glyphicon-inbox"}'><a href="<?php echo base_url();?>main/edit_video/<?php echo $sub->course;?>/<?php echo $sub->branch;?>/<?php echo $sub->semester;?>/<?php echo $sub->subject;?>"><?php echo $sub->subject;?>
    ...
    # code...
                                ...
                                <div class="file-box">
                                    <div class="file">
                                        <a href="<?php echo base_url();?>main/edit_view_video/<?php echo $d_id;?>/<?php echo $d_title;?>/<?php echo $d_description;?>/<?php echo $d_date;?>/<?php echo $dashcourse;?>/<?php echo $dashbranch;?>/<?php echo $dashsemester;?>/<?php echo $dashsubject;?>">
    ...
    <div class="modal inmodal" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                ...
                <form class="m-t" role="form" action="<?php echo base_url();?>main/edit_video/<?php echo $dashcourse;?>/<?php echo $dashbranch;?>/<?php echo $dashsemester;?>/<?php echo $dashsubject;?>" method = "POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="YouTube Video Embedded Link" class="form-control" name="embedded" required="" id="embedded_url">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" name="upload" value="10" id="upload_button" disabled>Upload Video</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    $("#embedded_url").keyup(function(){
        var dd = /(embed)/g;

        if(dd.test($("#embedded_url").val()))
        {
